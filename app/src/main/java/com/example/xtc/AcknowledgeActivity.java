...
public class AcknowledgeActivity extends AppCompatActivity {
    ...
    SensorEventListener sensorEventListener = new SensorEventListener() {
        @Override
        public void onSensorChanged(SensorEvent event) {                                    //CATCH ACCELEROMETER CHANGES
    ...
    private void GetLastItem(){
        ...
        Toast.makeText(AcknowledgeActivity.this,lastQuery.getRef().toString(),Toast.LENGTH_SHORT).show();
